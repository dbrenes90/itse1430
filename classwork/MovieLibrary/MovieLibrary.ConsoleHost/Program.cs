    ...
    public class Program
    {
        ...
        static int ReadInt32(int minimumValue)
        {
            do
            {
                ...
                //if (int.TryParse()) ; Use formal type name ( not primitive))
        ...
        //static void TakesAnInt(Int32 hours) { } compiles to the same thing, cannot have two functions that do the same thing
        ...
        static void FunWithStrings()
        {
            ...
            //String nullString = null; // identical to previous line

            int hours; //we will always use primitive types
            //Int32 hours; //compiler uses Int32 at runtime
            ...
            //String.Compare(emptyString, null); // exact same thing... always use formal type names instead of Primitive type//String formal type
