namespace CharacterCreator.Winforms
{
    partial class CharacterForm
    {
        ...
        private void InitializeComponent ()
        {
            ...
            this._numStrength.Value = new decimal(new int[] {
            50,
            0,
            0,
            0});
            ...
            this._numIntelligence.Value = new decimal(new int[] {
            50,
            0,
            0,
            0});
            ...
            this._numAgility.Value = new decimal(new int[] {
            50,
            0,
            0,
            0});
            ...
            this._numCharisma.Value = new decimal(new int[] {
            50,
            0,
            0,
            0});
            ...
            this._numConstitution.Value = new decimal(new int[] {
            50,
            0,
            0,
            0});
